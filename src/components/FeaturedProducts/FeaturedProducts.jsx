...
export default function FeaturedProducts(props) {
    ...
    return (
        <div className="flex overflow-hidden relative flex-col grow shrink self-stretch p-3 my-auto bg-white rounded-xl border border-gray-200 border-solid min-w-[240px] w-[216px]">
            <img
                loading="lazy"
                src={image}
                alt="Product image"
